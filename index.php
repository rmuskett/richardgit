...
<div id='mainContent'>
	...
	<div id='sideBar'>
		...
		<p>	For the reasons above the pages have been kept
			...
			Below you'll find a few links to the key chapters of
			ProGit and a few other useful links. ProGit is an 
			excellent and free resource hosted on the GitHub site,
			which provides all you'll likely to need to know about
			the topic.
			<br /><br />
